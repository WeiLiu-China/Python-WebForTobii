...
# 创建显示图像按钮
# btn_Show = tk.Button(root,text='显示图像', width=15, height=2,command=show)
btn_Show = tk.Button(root, text='显示图像', command=show).place(x=158, y=90)
# btn_Show.pack()    # 按钮位置
